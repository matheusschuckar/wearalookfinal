...
export default function OpenAppPage() {
  ...
  useEffect(() => {
    ...
    // Detecção de Navegadores Internos de Redes Sociais (In-App WebViews)
    const ua = navigator.userAgent || navigator.vendor || (window as any).opera;
    const isSocialWebView = /Instagram|FBAV|FBAN|TikTok|Twitter/i.test(ua);

    // Se estiver no Instagram/FB, NÃO tenta abrir o "look://" automaticamente,
    // pois isso causa o crash (a tela cinza).
    if (!isSocialWebView) {
...
const styles: Record<string, CSSProperties> = {
  ...
  button: {
    ...
    padding: "16px 24px",
    textDecoration: "none",
    borderRadius: "0px", // 🔥 Brutalista: Removidas as curvas (estava 6px)
    display: "inline-block",
    width: "fit-content",
    fontWeight: 700,
    textTransform: "uppercase",
